...
const PAGE = [
    ...
    '<li>Chọn <b>khối lượng (đòn bẩy)</b> — tự nhập số hoặc bấm nhanh. <b>x1</b> là giá nhích 1% ăn 1% vốn; <b>x20</b> là ăn <b>20%</b> vốn. Càng nhiều khối lượng, ăn càng đậm mà chết càng nhanh.</li>',
    ...
    'if(sh>0&&LV>1)note+="Mỗi 1% giá nhích = "+(LV)+"% vốn. ";',
    'if(sh>0)note+="⚠️ Lỗ KHÔNG dừng ở vốn: ăn hết vốn thì ăn tiếp vào ví, tới khi CHÁY SẠCH VÍ ("+vnd(SKS.balance)+" Dogcoin đang có). ";',
