...
const PAGE = [
    ...
    '<li>Chọn <b>khối lượng (đòn bẩy)</b> — tự nhập số hoặc bấm nhanh. <b>x1</b> là giá nhích 1% ăn 1% vốn; <b>x20</b> là ăn <b>20%</b> vốn. Đổi lại, giá đi ngược <b>5%</b> ở x20 là <b>cháy sạch vốn</b>. Càng nhiều khối lượng, ăn càng đậm mà chết càng nhanh.</li>',
    ...
    '<div class="skkv" id="skBurnRow" style="display:none"><span class="muted" id="skBurnL">⚠️ Cháy vốn nếu giá tới</span><b class="skn" id="skBurn">-</b></div>',
    ...
    'var kl=$("skPvKl");if(kl)kl.textContent=sh<1?"-":("x"+LV+" → "+sh+" CP ("+vnd(ref.basis)+" Dogcoin giá trị lệnh)");',
    'var note="";',
    'if(sh>0&&m>ref.c)note="Dư "+vnd(m-ref.c)+" không đủ thêm khối lượng nên giữ lại trong ví. ";',
    'if(sh>0&&LV>1)note+="Mỗi 1% giá nhích = "+(LV)+"% vốn. Giá đi ngược "+(Math.round(100/LV*10)/10)+"% là CHÁY hết vốn. ";',
    ...
    'var br=$("skBurnRow");var showB=p.burnAt>0&&(sht||p.burnAt>=300);',
    'br.style.display=showB?"flex":"none";',
    'if(showB){$("skBurn").textContent=vnd(p.burnAt);',
    '$("skBurnL").textContent=sht?"⚠️ Cháy vốn nếu giá LÊN tới":"⚠️ Cháy vốn nếu giá XUỐNG tới"}',
