...
const PAGE = [
    ...
    '<div id="skHelpBody">',
    '<ol>',
    '<li>Giá DOG <b>nhảy 10 giây một lần</b>, mỗi lần vẽ thêm một cây nến. Nến <b style="color:var(--green)">xanh</b> là giá lên, <b style="color:var(--red)">đỏ</b> là giá xuống.</li>',
    ...
    '</div>',
    '<div id="skTf">',
    '<button id="sktf1" class="on" onclick="skTf(1)">10s</button>',
    '<button id="sktf3" onclick="skTf(3)">30s</button>',
    '<button id="sktf6" onclick="skTf(6)">1m</button>',
    '<button id="sktf30" onclick="skTf(30)">5m</button>',
    ...
    '</div>',
    '<div id="skPcts">',
    '<div><div class="t">1 phút</div><div class="v" id="skP5">-</div></div>',
    '<div><div class="t">10 phút</div><div class="v" id="skP30">-</div></div>',
    '<div><div class="t">1 giờ</div><div class="v" id="skP120">-</div></div>',
    '</div>',
    ...
    '[1,3,6,30].forEach(function(k){var b=$("sktf"+k);if(b)b.classList.toggle("on",k===n)});skRender()}',
    ...
    'pctAt(6,"skP5");pctAt(60,"skP30");pctAt(rc.length,"skP120");',
    ...
    '[1,3,6,30].forEach(function(k){var q=$("sktf"+k);if(q)q.classList.toggle("on",k===SKTF)});',
