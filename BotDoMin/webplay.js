...
// 🪙 14/09: khung tỉ lệ đổi vàng (icon Đồng Vàng -> Dogcoin)
    ...
    '<div class="muted" style="font-size:12px;margin-top:8px;text-align:center">Càng nhiều cầu lửa hệ số càng cao - đạp trúng lửa là mất tiền cược ván đó. Cỏ 🍀 KHÔNG tặng sẵn - muốn thì tick mua (40% cược).</div>',
    '</div>',
    '</div>', // hết #pageStair
    ...
    'var fe=$("mExtraFee");if(fe)fe.textContent=vnd(Math.floor((mNum("mBet")||0)*0.4));',
