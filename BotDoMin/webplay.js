...
const PAGE = [
    ...
    // online === null = KHÔNG kiểm được (REST API tắt) -> VẪN cho bấm, mod sẽ tự chặn
    'var unknown=GB.linked&&GB.online===null;',
    'var can=GB.linked&&(GB.online===true||unknown)&&!gbBusy;',
