...
- **Dòng lịch sử ván** (Discord + bảng 20 ván trên web): mỗi người chỉ kể ô **ĂN ĐƯỢC** (tối đa 3), ô thua gói thành "N ô, trượt hết", tiền rút gọn `k/tr`; kèm dòng ⚡ kể **ô nào được bốc hệ số nhân**. `histEntry.nhan` lưu bảng nhân của ván. Ván cũ thiếu trường này thì chỉ hiện tổng, không bịa.
