...
- Bộ kiểm riêng: `node TaiXiu/kiemtra/cua-test.js` (lõi tiền) · `trang-test.js` (giao diện) · `pham-vi-test.js` (biến xuyên file) · `web-test.js` + `tratien-test.js` (cần bot test đang chạy).
